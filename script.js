...
(function scrollReveal(){
  ...
  const elems = $$('.project-card, .skill, .testi-item, .profile-card, .card, .timeline-item, .hero-text');
...
(function contactForm(){
  ...
  if(form){
    form.addEventListener('submit', (e)=>{
      ...
      formMessage('Bericht verzonden — bedankt! Ik neem snel contact op.', false);
      form.reset();
    });
  }
